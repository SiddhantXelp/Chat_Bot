...
<Tabs>
  ...
  <TabPanel>
      ...
      <img
          className="inline-block h-12 w-12 rounded-full ring-2 ring-black bg-indigo-500"
          src="{user.avatarUrl}"
          alt="bot"
        />
      </div>
  ...
  <TabPanel>
    <div className="max-w-sm w-full  lg:max-w-full lg:flex mt-[30px] mr-[30px] h-[540px]">
      ...
      <div className=" w-[350px] border-r border-b border-l border-gray-400 lg:border-l lg:border-t lg:border-gray-400 bg-white rounded-[15px] lg:rounded-[15px] leading-normal overflow-hidden">
        <div className=" text-gray-900 font-bold text-xl  bg-indigo-500 w-auto  h-[190px] bottom-0 ">
        ...
        <p className="text-black-700 pl-[40px] pt-10 font-normal ">Bot name</p>
        ...
        <p className="text-black-900 text-center p-[40px]  font-normal text-md w-[350px]">
          Describe your chatbot and tell users how it can help .
        </p>
