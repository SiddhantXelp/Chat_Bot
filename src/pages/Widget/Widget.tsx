...
const Widget = () => {
  ...
  const [botName, setBotName] = useState("Air Bot");
  const [description, setDescription] = useState("Describe your bot");
          ...
          <div className="flex flex-col  min-w-[770px]">
            ...
            >
              <div className="flex items-center">
                ...
                <h1 className="text-[19px] font-semibold ml-6  ">
                  General Settings
                </h1>
              </div>
              <i
            ...
            {settingVisible ? (
              <div className="max-w-[710px] h-[480px] ml-6 border border-slate-200 mb-6">
                <div className="pl-4 pr-4  mt-3">
                  ...
                  <input
                    ...
                    className="min-w-[680px] mt-2 py-[8px] border rounded-[6px] border-zinc-300"
                  />
                </div>
            ...
            {visible ? (
              <div className="max-w-[710px] h-[990px] ml-6 border border-slate-200 mb-6">
                <h1 className="text-[21px] text-[#9ba6b3] pl-4 my-3">
                  MINIMIZED WIDGET
                </h1>
                ...
                <h1 className="text-[21px] text-[#9ba6b3] pl-4 mt-11 ">
                  CHAT SCREEN
                </h1>
                <div className="flex  items-center  gap-8">
                  <div className="pl-4 pr-4  mt-3 ">
                  ...
                  <div className="pl-4 pr-4  mt-3 ">
                    ...
                    <div>
                      ...
                      {colorPickerVisible15 ? (
                        <div className="fixed top-[500px] z-99">
                          {" "}
                          <SketchPicker
                            color={bubbleBackground}
